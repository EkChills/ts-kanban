...
const BoardOption = ({boardName}:{boardName:string}) => {
  ...
  return (
    <div className={`flex pl-[1.5rem] cursor-pointer items-center space-x-[.75rem] py-[1rem] rounded-r-full ${selectedBoard.trim().toLowerCase() === boardName.trim().toLowerCase() ? 'bg-[#635FC7]' : 'bg-[none]'}`}>
